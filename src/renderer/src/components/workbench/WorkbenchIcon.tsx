...
export type WorkbenchIconName = 'loop' | 'automation' | 'runs' | 'skills' | 'sync' | 'remote' | 'machine' | 'setup' | 'tools' | 'plus' | 'terminal' | 'agent' | 'files' | 'stop' | 'play' | 'refresh' | 'close' | 'chevron' | 'check' | 'warning' | 'search' | 'trash' | 'copy' | 'edit' | 'menu' | 'external' | 'branch' | 'download'
